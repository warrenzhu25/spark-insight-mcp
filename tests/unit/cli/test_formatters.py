...
from spark_history_mcp.models.spark_types import (
    ApplicationInfo, ApplicationAttemptInfo, JobData, StageData
)
...
class TestOutputFormatterHuman:
    ...
    def test_application_and_job_and_stage_objects(self):
        ...
        # Stage
        stage = StageData(status='COMPLETE', stage_id=1, num_tasks=10, name='S', details='D')
    ...
    def test_job_and_aggregated_stage_and_resource_comparison_results(self):
        ...
        job_comp = {
            'applications': {
                'app1': {'id': 'a1', 'job_stats': {'duration_ms': 1000}, 'success_rate': 0.9},
                'app2': {'id': 'a2', 'job_stats': {'duration_ms': 1500}, 'success_rate': 0.95},
            },
            'job_comparison': {},
            'timing_analysis': {}
        }
        ...
        res_comp = {
            'applications': {
                'app1': {'id': 'a1', 'cores_granted': 4, 'max_cores': 8, 'memory_per_executor_mb': 4096},
                'app2': {'id': 'a2', 'cores_granted': 6, 'max_cores': 12, 'memory_per_executor_mb': 6144}
            },
            'resource_comparison': {}
        }
    ...
    def test_comparison_result_full_with_recommendations(self):
        ...
        comparison = {
            ...
            'performance_comparison': {
                'executor_comparison': {
                    'applications': {
                        'app1': {'executor_metrics': {'completed_tasks': 10, 'total_input_bytes': 1000, 'total_duration': 20}},
                        'app2': {'executor_metrics': {'completed_tasks': 12, 'total_input_bytes': 2000, 'total_duration': 25}},
                    },
                    ...
                    'top_stage_differences': [
                        {
                            ...
                            'time_difference': {'percentage': 15, 'slower_application': 'app1'},
    ...
    def test_executor_comparison_result(self):
        ...
        exec_comp = {
            ...
            'efficiency_ratios': {
                'tasks_per_executor_ratio_change': '+0.0%'
            }
        }
    ...
    def test_stage_comparison_deep_metrics(self):
        ...
        stage_data = {
            'stage_comparison': {
                'stage1': {'stage_id': 1, 'name': 'Stage A', 'status': 'COMPLETE', 'app_id': 'a1'},
                'stage2': {'stage_id': 2, 'name': 'Stage B', 'status': 'COMPLETE', 'app_id': 'a2'},
            },
            'significant_differences': {
                ...
                'task_distributions': {
                    'executor_run_time': {'median': {'stage1': 10, 'stage2': 5}, 'p90': {'stage1': 15, 'stage2': 8}, 'p99': {'stage1': 20, 'stage2': 9}}
                },
    ...
    def test_timeline_comparison_full(self):
        fmt = OutputFormatter(format_type="human")
        timeline = {
            'app1_info': {'name': 'App1', 'duration_seconds': 120.0, 'start_time': '2025-09-27T12:00:00Z', 'end_time': '2025-09-27T12:02:00Z'},
            'app2_info': {'name': 'App2', 'duration_seconds': 100.0, 'start_time': '2025-09-27T12:03:00Z', 'end_time': '2025-09-27T12:04:40Z'},
            'timeline_comparison': [
                {
                    'interval': 1,
            ...
            'resource_efficiency': {
                'app1': {'efficiency_score': 0.8, 'peak_executor_count': 10, 'avg_executor_count': 6.5},
                'app2': {'efficiency_score': 0.7, 'peak_executor_count': 8, 'avg_executor_count': 5.0}
            },
            'summary': {'note': 'ok'},
            'recommendations': [{'priority': 'MEDIUM', 'issue': 'Tune executors', 'suggestion': 'Increase cores'}]
        }
